...
OAuth2Server.prototype.authenticate = function(request, response, options, callback, req) {
...
OAuth2Server.prototype.authorize = function(request, response, options, callback, req) {
  options = _.assign({
...
OAuth2Server.prototype.token = function(request, response, options, callback, req) {
  options = _.assign({
