...
AbstractGrantType.prototype.generateAccessToken = function(client, user, scope, req) {
  if (this.model.generateAccessToken) {
    return promisify(this.model.generateAccessToken, 4).call(this.model, client, user, scope, req)
...
AbstractGrantType.prototype.generateRefreshToken = function(client, user, scope, req) {
  if (this.model.generateRefreshToken) {
    return promisify(this.model.generateRefreshToken, 4).call(this.model, client, user, scope, req)
 ...
 */
AbstractGrantType.prototype.validateScope = function(user, client, scope, req) {
