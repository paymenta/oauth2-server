...
TokenHandler.prototype.handle = function(request, response, req) {
  ...
  return Promise.bind(this)
    .then(function() {
      return this.getClient(request, response, req);
    })
    .then(function(client) {
      return this.handleGrantType(request, client, req);
    })
    .tap(function(data) {
...
TokenHandler.prototype.getClient = function(request, response, req) {
  ...
  return promisify(this.model.getClient, 3).call(this.model, credentials.clientId, credentials.clientSecret, req)
    .then(function(client) {
      if (!client) {
...
TokenHandler.prototype.handleGrantType = function(request, client, req) {
  var grantType = request.body.grant_type;
